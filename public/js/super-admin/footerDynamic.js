...
function addData() {
    ...
    $.ajax({
        url: "/super-admin/addDynamicTableDetails",
        type: "POST",
        data: { name: "footerPage", description: mainArr, _token: _token },
        beforeSend: function () {
            $(".loader").show();
        },
...
function viewData() {
    $.ajax({
        url: "/super-admin/viewDynamicTableDetails",
        type: "GET",
        beforeSend: function () {
            $(".loader").show();
        },
...
function updateData() {
    ...
    var _token = $('input[name=_token]').val();
    $.ajax({
        url: "/super-admin/updateDynamicTableDetails",
        type: "POST",
        data: { name: "footerPage", description: mainArr, id:id, _token: _token },
        beforeSend: function () {
            $(".loader").show();
        },
        success: function (response) {
...
function deleteData() {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            var _token = $('input[name=_token]').val();
            $.ajax({
                url: "/super-admin/deleteDynamicTableDetails",
                type: "POST",

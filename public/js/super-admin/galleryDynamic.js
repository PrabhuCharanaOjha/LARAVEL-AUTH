...
function addData() {
    ...
    if (validationResponse == undefined) {
        ...
        if (uploadFile != false) {
            ...
            $.ajax({
                url: "/api/super-admin/addGallery",
                type: "POST",
                data: formData,
                cache: false,
                contentType: false,
                ...
                success: function (response) {
                    ...
                    if (response.msg == "success") {
                        successMessageSwitAlert("Gallery Added Successfully", "");
...
function viewData() {
    $.ajax({
        url: "/api/super-admin/viewGallery",
        type: "GET",
        headers:{
            'Authorization': 'Bearer '+sessionStorage.getItem("token"),
        },
...
function updateData() {
    ...
    if (validationResponse == undefined) {
        ...
        if (uploadFile != false) {
            ...
            formData.append('_token', _token);
            $.ajax({
                url: "/api/super-admin/updateGallery",
                type: "POST",
                data: formData,
                cache: false,
                contentType: false,
                ...
                success: function (response) {
                    ...
                    // console.log(response);
                    if (response.msg == "success") {
                        successMessageSwitAlert("Gallery Updated Successfully", "");
                        cancelUpdate();
                        viewData();
                    } else {
                        errorMessageSwitAlert(response.reason, "");
...
function deleteData(id, name){
	Swal.fire({
		...
		if (result.isConfirmed) {
            var _token = $('input[name=_token]').val();
            $.ajax({
                url: "/api/super-admin/deleteGallery",
                type: "POST",
                ...
                success: function (response) {
                    ...
                    console.log(response);
                    if(response.msg == 'success'){
                        successMessageSwitAlert("Gallery Deleted Successfully", "");
                        viewData();
                    }else{
                        errorMessageSwitAlert(response.reason, "");
                    }

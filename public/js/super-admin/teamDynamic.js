            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.msg == "success") {
                        successMessageSwitAlert("Team Added Successfully", "");
...
function updateData() {
    ...
    if (validationResponse == undefined) {
        ...
        if (uploadFile != false) {
            ...
            formData.append('_token', _token);
            $.ajax({
                url: "/api/super-admin/updateTeam",
                type: "POST",
                data: formData,
                cache: false,
                contentType: false,
                ...
                success: function (response) {
                    ...
                    // console.log(response);
                    if (response.msg == "success") {
                        successMessageSwitAlert("Team Updated Successfully", "");
                        cancelUpdate();
                        viewData();
                    } else {
                        errorMessageSwitAlert(response.reason, "");
...
function deleteData(id, name){
	Swal.fire({
		...
		if (result.isConfirmed) {
            var _token = $('input[name=_token]').val();
            $.ajax({
                url: "/api/super-admin/deleteTeam",
                type: "POST",
                ...
                success: function (response) {
                    ...
                    console.log(response);
                    if(response.msg == 'success'){
                        successMessageSwitAlert("Team Deleted Successfully", "");
                        viewData();
                    }else{
                        errorMessageSwitAlert(response.reason, "");
                    }
